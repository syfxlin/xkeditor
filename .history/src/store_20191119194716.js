...
const actions = {
  ...
  toolbarClick(operate) {
    ...
    if (operate.match(/^h(\d)/)) {
      ...
      this.showAceToolbarModal(operate, '添加表格');
      return;
    } else if (operate === 'time') {
      str = new Date().toLocaleString();
    } else if (operate === 'link') {
      this.showAceToolbarModal(operate, '添加链接');
      return;
    } else if (operate === 'image') {
      this.showAceToolbarModal(operate, '添加图片');
      return;
    } else if (operate === 'video') {
      this.showAceToolbarModal(operate, '添加视频');
      return;
    } else if (operate === 'graff') {
      this.showAceToolbarModal(operate, '上传涂鸦图');
      return;
    } else if (
      ...
      this.showAceToolbarModal('localStorage', '保存到本地');
      return;
    } else if (operate === 'getLocalStorage') {
      this.showAceToolbarModal('localStorage', '从本地读取');
      return;
    } else if (operate === 'removeLocalStorage') {
      this.showAceToolbarModal('localStorage', '删除本地存储');
      return;
    } else if (operate === 'help') {
      this.showAceToolbarModal(operate, '帮助');
      return;
    } else if (operate === 'info') {
      this.showAceToolbarModal(operate, '关于');
      return;
    }
