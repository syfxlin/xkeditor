...
const actions = {
  ...
  switchToHtml() {
    if (state.isMarkdownMode) {
      ...
      state.aceEditor
        .getSession()
        .setValue(toHtml(state.aceEditor.getSession().getValue(), false));
  ...
  switchToMarkdown() {
    if (!state.isMarkdownMode) {
      ...
      state.aceEditor
        .getSession()
        .setValue(toMarkdown(state.aceEditor.getSession().getValue(), true));
